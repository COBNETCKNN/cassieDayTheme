...
<div id="form-popup" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
    <div class="bg-white py-7 lg:py-10 px-5 lg:px-10 rounded-xl max-w-[22.5rem] lg:max-w-[35.625rem] relative">
        <div class="w-fit h-fit">
            <button id="close-popup" class="absolute top-3 lg:top-5 right-3 lg:right-5">
