...
$default_class = 'imageBlockPages';
$default_id = 'imageBlockPages';
...
$desktopSpacing = get_spacing_value_pricing_cards($spacing, 'desktop', '150px 0px 150px 0px');
...
<section id="<?php echo $section_id; ?>" class="<?php echo $section_class; ?> bg-white relative font-plus">
    <div class="container mx-auto w-full h-full">
        <div class="mx-5 lg:mx-0">
            ...
            ?>
            <div class="pagesPricingCards my-auto relative" style="text-align: <?php echo $alignment_style; ?>;">
        ...
        <!-- Images Repeater -->
        <div class="imagesRepeater_wrapper flex justify-center items-start">
            <?php if( have_rows('image_block_images_repeater') ): ?>
                <?php while( have_rows('image_block_images_repeater') ): the_row(); 
                
                $imageBlockImage = get_sub_field('image');
                $url = $imageBlockImage['url'];
                $alt = $imageBlockImage['alt'];
                $size = 'programs-featured';
                $thumb = $imageBlockImage['sizes'][ $size ];
                
                $imageTitle = get_sub_field('title');
                $imageDescription = get_sub_field('description');
                $alignContentImages = get_sub_field('align_content_images');
                ?>

                    <div class="imageBlock_content__wrapper mx-5 my-10 md:my-0" style="text-align: <?php echo $alignContentImages; ?>;">
                        <img class="mb-3" src="<?php echo esc_url($thumb); ?>" alt="<?php echo esc_attr($alt); ?>" />
                        <h5 class="mb-5"><?php echo $imageTitle; ?></h5>
                        <div><?php echo $imageDescription; ?></div>
    ...
    <?php if($showShapeDecoration) { ?>
        <svg class="coachesDeco" width="325" height="627" viewBox="0 0 325 627" fill="none" xmlns="http://www.w3.org/2000/svg">
