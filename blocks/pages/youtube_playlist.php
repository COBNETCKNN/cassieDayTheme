            ...
            <div class="videosPlaylist_wrapper">
                <div class="lg:grid lg:grid-cols-5 gap-14">
                    ...
                    <div class="col-span-2">
                        <div class="videoPlaylistGrid lg:grid lg:grid-cols-3 gap-4 my-auto overflow-y-auto">
                            <?php if( have_rows('videos_playlist') ): ?>
                                ...
                                ?>
                                    <!-- Playlist Item -->
                                    <div class="col-span-3 flex items-center relative my-5 lg:my-0 video-item"> <!-- Added video-item class -->
                                        <!-- Thumbnail -->
