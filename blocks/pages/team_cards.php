...
$default_class = 'pagesTeamCards';
$default_id = 'pagesTeamCards';
...
function get_spacing_value_team_cards($spacing, $key, $default = '0px 0px 0px 0px') {
    return isset($spacing[$key]) && !empty($spacing[$key]) ? $spacing[$key] : $default;
}

$desktopSpacing = get_spacing_value_team_cards($spacing, 'desktop', '100px 0px 100px 0px');
$tabletSpacing = get_spacing_value_team_cards($spacing, 'tablet', '50px 0px 50px 0px');
$mobileSpacing = get_spacing_value_team_cards($spacing, 'mobile', '30px 0px 30px 0px');
    ...
    <div class="container mx-auto w-full h-full">
        ...
        <?php if( have_rows('team_cards') ): 
            ...
            <?php while( have_rows('team_cards') ): the_row(); 
                ...
                $coachImage = get_sub_field('coach_image');
                // Image variables.
                $url = $coachImage['url'];
                $alt = $coachImage['alt'];
                $size = 'coach-featured';
                    ...
                    <div class="coachesGrid grid lg:grid-cols-5 gap-10 lg:gap-4">
                        ...
                        <div class="lg:col-span-3">
                            <?php if( have_rows('coach_content') ): ?>
                                ...
                                $coachPosition = get_sub_field('coach_position');
                                $coachBiography = get_sub_field('coach_biography');
                                ?>

                                <h4 class="coachName"><?php echo $coachName; ?></h4>
                                <div class="CoachPosition coachesPosition<?php echo $cardIndex; ?>"><?php echo $coachPosition; ?></div>
                                <?php if ($coachBiography): ?>
                                    <div class="coachBioWrapper">
                                        <div class="coachBio coachBioContent">
                                            <?php echo wp_kses_post($coachBiography); ?>
                                        </div>
                                        <button class="toggleBioBtn font-bold mt-3">Show More</button>
                                    </div>
                                <?php endif; ?>
                                <?php 
                                $cardIndex++;
