...
$default_class = 'pageReviews';
$default_id = 'pageReviews';
...
function get_spacing_value_page_reviews($spacing, $key, $default = '0px 0px 0px 0px') {
    return isset($spacing[$key]) && !empty($spacing[$key]) ? $spacing[$key] : $default;
}

$desktopSpacing = get_spacing_value_page_reviews($spacing, 'desktop', '100px 0px 100px 0px');
$tabletSpacing = get_spacing_value_page_reviews($spacing, 'tablet', '50px 0px 50px 0px');
$mobileSpacing = get_spacing_value_page_reviews($spacing, 'mobile', '30px 0px 30px 0px');
...
if ($showSection) { ?>
 ...
 <section id="<?php echo $section_id; ?>" class="<?php echo $section_class; ?> font-plus relative">
    <div class="container mx-auto">
        ...
        <div class="pageReviews_content md:mx-0" style="text-align: <?php echo $alignment_style; ?>;">
